...
// export function createOnePayment() {}

// export function createMultiplePayment() {}

export function createPayment(data) {
   return dispatch => {
      return apiCall("post", "/api/payments", { payment: data })
         .then(res => {
...
export function searchPayments(search) {
   return dispatch => {
      return apiCall("get", "/api/payments", { params: { search } })
         .then(res => {
            dispatch(removeError());
            return res;
         })
